...
<body>
  ...
  <div class="container">
    <div class="row">
      ...
      $resalt_last_view = mysqli_query($conn, $sql_last_view) or die ("Error in query: $sql_last_view " . mysqli_error($conn));
      ...
      //เรียกดูวิวของสินค้านั้นๆ
          ...
          $resalt_updateview = $conn->query($update_view);
          //อัพเดทวิวสินค้าใหม่
      ...
      <div class="col-md-12">
        <div class="container" style="margin-top: 50px">
          <div class="row">
            <div class="col-md-6">
                <?php echo"<img src='backend/p_img/".$row['p_img']."'width='100%' height='80%' id='myImg'>";?>
            ...
            <div class="col-md-6">
              ...
              <br> จำนวนการเข้าชม  <?php echo $row["p_view"];?> ครั้ง
                ...
                <input type="hidden" name="product_id" value="<?php echo $row_prd['p_id']; ?>">
                <input type="hidden" name="product_name" value="<?php echo $row_prd['p_name']; ?>">
               <input type="hidden" name="product_price" value="<?php echo $row_prd['p_price']; ?>">
               <input type="hidden" name="product_qty" value="1"> <!-- จำนวนสินค้าจะถูกตั้งเป็น 1 -->
               <?php
                if($member_id!=''){
               ?>

...
echo  ' <table id="productt" class="table table-bordered table-striped">';
  //หัวข้อตาราง
    echo "<thead>
      <th>id</th>
      <th>type</th>
  ...
  echo "<tbody>";
    ...
    //ลบข้อมูล
    echo "<td><a href='product_del.php?ID=$row[0]' onclick=\"return confirm('Do you want to delete this record? !!!')\" class='btn btn-danger btn-xs'>del</a></td> ";
  echo "</tr>";
  }
echo "</table>";
//5. close connection
